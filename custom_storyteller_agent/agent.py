...
# !/usr/bin/env python3
"""
Example of implementing retry logic for handling 503 Service Unavailable errors.
"""
...
async def call_agent_with_retry(agent_function, prompt: str, max_retries: int = 5) -> Any:
    """
    Call an agent function with exponential backoff retry logic.
    ...
    for attempt in range(max_retries):
        try:
            ...
            result = await agent_function(prompt)
            print("✅ Success!")
            return result
            ...
            if "503" in error_msg or "overloaded" in error_msg.lower():
                if attempt < max_retries - 1:  # Don't wait on the last attempt
                    ...
                    print(f"❌ Model overloaded. Waiting {wait_time:.2f} seconds before retry...")
